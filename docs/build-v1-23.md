...
### v1.23 — 2026-04-07
- Replaced the old rolling heat model with a daily carry formula based on unique fires and unique detail-page views
- Added unique view tracking for idea detail clicks
- Added a configurable view-weight coefficient with a default of `0.2`
...
- The dev seed should include mocked timestamps, mocked Frieda counts, and mocked view activity so the feed looks active
...
- [ ] `dev.sh` uses a seeded dev database with 50 ideas, mocked timestamps, mocked Frieda counts, and mocked views
...
*End of build specification v1.23. Next amendment will be `build-v1-24.md`.*
