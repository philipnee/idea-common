...
- Gemini must choose from a fixed allowed vocabulary
- If Gemini is unavailable, times out, or returns invalid output, use a deterministic fallback tagger
- If the fallback cannot confidently classify the idea, save it without tags
...
- [ ] A deterministic fallback tagger exists
...
*End of build specification v1.20. Next amendment will be `build-v1-21.md`.*
