...
After reading this file, read the latest relevant spec in `docs/build-*.md` before implementation work. The current baseline spec is `docs/build-v1-23.md`.
...
- `docs/build-v1-23.md` says the next amendment should be `build-v1-24.md`, so the next spec file path should be `docs/build-v1-24.md`.
