...
After reading this file, read the latest relevant spec in `docs/build-*.md` before implementation work. The current baseline spec is `docs/build-v1-01.md`.
...
- `docs/build-v1-01.md` says the next amendment should be `build-v1-02.md`, so the next spec file path should be `docs/build-v1-02.md`.
